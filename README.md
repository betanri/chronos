...
This repository is organized into two main sections plus one companion repo:
...
## 3) [POST-FIT EVALUATION METRICS (PhyloChronoRank)](https://github.com/betanri/PhyloChronoRank)

This companion repo is the comparison layer applied after fitting is finished. It asks a different question from model fitting: once you already have dated trees, which one behaves most plausibly as a chronogram?
